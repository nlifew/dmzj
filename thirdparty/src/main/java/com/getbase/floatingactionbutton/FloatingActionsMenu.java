...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    mButtonSpacing = (int) (res.getDimension(R.dimen.fab_actions_spacing) - res.getDimension(R.dimen.fab_shadow_radius) - getResources().getDimension(R.dimen.fab_shadow_offset));
    mLabelsMargin = res.getDimensionPixelSize(R.dimen.fab_labels_margin);
    mLabelsVerticalOffset = res.getDimensionPixelSize(R.dimen.fab_shadow_offset);

    mTouchDelegateGroup = new TouchDelegateGroup(this);
    setTouchDelegate(mTouchDelegateGroup);

    TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.FloatingActionsMenu, 0, 0);
    mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, res.getColor(android.R.color.white));
    mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, res.getColor(android.R.color.holo_blue_dark));
    mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, res.getColor(android.R.color.holo_blue_light));
  ...
  private void createAddButton(Context context) {
    ...
    mAddButton.setFabSize(mAddButtonSize);
  ...
  public void addButton(FloatingActionButton button) {
    addView(button.toView(), mButtonsCount - 1);
    mButtonsCount++;
  ...
  private void createLabels() {
    ...
    for (int i = 0; i < mButtonsCount; i++) {
      ...
      CharSequence title = button.getTitle();
